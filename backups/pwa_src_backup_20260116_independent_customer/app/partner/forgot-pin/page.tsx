...
export default function PartnerForgotPinPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_URL}/partner-portal/request-pin-reset`, {
        method: 'POST',
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1">Add meg a partner kodot es az email cimet</p>
        </div>
          ...
          {success ? (
            <div className="text-center">
              ...
              <p className="text-slate-400 mb-4">
                Ha a partner kod es az email cim helyes, a PIN visszaallito linket elkuldtuk.
              </p>
              <Link
                href="/partner"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="pl. ACME"
                  className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent uppercase"
                />
              </div>
              ...
              <p className="text-slate-500 text-xs">
                A PIN visszaallito linket a partner ceghez tartozo email cimre kuldjuk.
              </p>
